...
{
	private $full_url = "http://user:pass@www.example.com:8080/pub/create.php?a=b#files";
	...
	public function testExampleOne()
	{
		...
		$actual   = http_build_url(
			"http://user@www.example.com/pub/create.php?a=b#files",
			array(
				"scheme" => "ftp",
	...
	{
		$expected = 'http://user:pass@www.example.com:8080/pub/create.php#files';
	...
	{
		$expected = 'http://user:pass@foobar.com:8080/pub/create.php?a=b#files';
	...
	{
		return array(
			array('a=c', 'http://user:pass@www.example.com:8080/pub/create.php?a=c#files'),
			array('d=a', 'http://user:pass@www.example.com:8080/pub/create.php?a=b&d=a#files')
		);
	}
	...
	{
		return array(
			array('HTTP_URL_REPLACE', 'http://user:pass@www.example.com:8080/pub/create.php?a=b#files'),
			array('HTTP_URL_JOIN_PATH', 'http://user:pass@www.example.com:8080/pub/create.php?a=b#files'),
			array('HTTP_URL_JOIN_QUERY', 'http://user:pass@www.example.com:8080/pub/create.php?a=b#files'),
			array('HTTP_URL_STRIP_USER', 'http://www.example.com:8080/pub/create.php?a=b#files'),
			array('HTTP_URL_STRIP_PASS', 'http://user@www.example.com:8080/pub/create.php?a=b#files'),
			array('HTTP_URL_STRIP_AUTH', 'http://www.example.com:8080/pub/create.php?a=b#files'),
			array('HTTP_URL_STRIP_PORT', 'http://user:pass@www.example.com/pub/create.php?a=b#files'),
			array('HTTP_URL_STRIP_PATH', 'http://user:pass@www.example.com:8080/?a=b#files'),
			array('HTTP_URL_STRIP_QUERY', 'http://user:pass@www.example.com:8080/pub/create.php#files'),
			array('HTTP_URL_STRIP_FRAGMENT', 'http://user:pass@www.example.com:8080/pub/create.php?a=b'),
